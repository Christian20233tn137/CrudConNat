...
class PersonaService {
  ...
  async createPersona(persona) {
    ...
    const personaByCorreo = await PersonaRepository.getPersonaByCorreo(
      persona.correo
    );
  ...
  async updatePersona(id, persona) {
    ...
    //Validar que el correo no exista en la base de datos
    const personaByCorreoAndNotId =
      await PersonaRepository.getPersonaByCorreoAndNotId(id, persona.correo);
    ...
    const personaByRFCAndNotId =
      await PersonaRepository.getPersonaByRFCAndNotId(id, persona.rfc);
